				...
				<div className="page-container">
					...
					<main className="practical">
						...
						<TextImage
							...
							imageFirst={true}
							altText={"Billede af et bord med mad stillet frem"}
						/>
						<Divider />
						<TextImage
							id="parkering"
							...
							altText={"Kort over parkeringsplads ved Morningtrains kontorer"}
						/>
						<Divider />
						<TextImage
							id="dresscode"
