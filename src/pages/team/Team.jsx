	...
	return (
		<section className="team page-container">
			<div className="team__desktopblop">
				<Blurryblop
					style={{ top: "100px", left: "800px", width: "700px" }}
				/>
				<Blurryblop style={{ top: "800px", left: "50px" }} />
				<Blurryblop
					style={{ top: "1700px", left: "700px", width: "500px" }}
				/>
			</div>
            <div className="team__mobileblop">
				...
				/>
				<Blurryblop style={{ top: "1100px", left: "30px", height:"300px" }} />
				<Blurryblop
					style={{ top: "2060px", left: "0px"  }}
				/>
			</div>
			<ContentHeader
