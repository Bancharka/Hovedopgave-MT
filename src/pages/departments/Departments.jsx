    ...
    <section className="departments">
      ...
      <div className="departments__content">
        ...
        <div className="departments__header">
          <div className="departments__logo-wrapper">
            <p className="departments__intro">VELKOMMEN TIL</p>
            <img className="departments__logo" src="src/assets/img/logo-mt.svg" alt="morningtrain logo" />
          </div>
        </div>
