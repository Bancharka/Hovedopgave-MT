        ...
        <>
            <section className="ressources page-container">
                ...
                <TextImage
                    ...
                    links={[
                        { text: 'Wordpress dokumentation', href: 'https://wordpress.org/documentation/article/wordpress-block-editor/' },
                        { text: 'Wordpress enkelte blokke dokumentation', href: 'https://wordpress.github.io/gutenberg/?path=/story/docs-introduction--page' }
                    ]}
                />
                <img className='ressources__images' src="img/ressources/wp-block-editor.jpg" alt="Wordpress block editor" />
                <Divider />
                <TextImage
                    ...
                    links={[
                        { text: 'Morning Medley dokumentation', href: 'internal-projects-morningmedley-docs.mtt-prod.mtra.in' }
                    ]}
                />
                <img className='ressources__images' src="img/ressources/morningmedley.png" alt="Morning Medley" />
                <Divider />
                <TextImage
                    heading="Figma"
                    ...
                    links={[
                        { text: 'Figma dokumentation', href: 'https://help.figma.com/hc/en-us' }
                    ]}
                />
                <img className='ressources__images' src="img/ressources/figma.png" alt="Figma" />
                <Divider />
                <TextImage
                    heading="React"
                    ...
                    links={[
                        { text: 'React dokumentation', href: 'https://react.dev/learn' }
                    ]}
                />
                <img className='ressources__images' src="img/ressources/react.png" alt="React" />
                <Divider />
                <TextImage
                    heading="Git"
                    ...
                    links={[
                        { text: 'Git dokumentation', href: 'https://git-scm.com/doc' }
                    ]}
                />
                <img className='ressources__images' src="img/ressources/git.png" alt="Git" />
                <Divider />
                <TextImage
                    heading="BEM"
                    ...
                    links={[
                        { text: 'BEM dokumentation', href: 'https://getbem.com/introduction/' }
                    ]}
                />
                <img className='ressources__images' src="img/ressources/bem.png" alt="BEM" />
                <img className='ressources__images' src="img/ressources/bem1.png" alt="BEM" />
                <Divider />
                <PageNav />
                <Footer />
            </section>
