...
export default function Ressources() {
	const sidenavs = [
		{ id: "wordpress", label: "Wordpress Block Editor" },
		{ id: "morningmedley", label: "Morning Medley" },
			...
			<div className="nav-seperator">
				...
				<div className="page-container">
					...
					<div className="ressources__mobileblop">
						<Blurryblop style={{ top: "50px", left: "-50px" }} />
						<Blurryblop style={{ top: "600px", left: "60px" }} />
						<Blurryblop style={{ top: "2100px", left: "50px" }} />
						<Blurryblop style={{ top: "3500px", left: "40px" }} />
					</div>
					<ContentHeader
					...
					<main className="ressources">
						...
						<img
							...
							alt="Et beskrivende screenshot til at forklare funktioner i Wordpress block editor"
						/>
						...
						<img
							...
							alt="Screenshot af Morningmedley, et internt værktøj i Morningtrain"
						/>
						...
						<img
							...
							alt="Screenshot af Figma, med forklarende tekst af knapper"
						/>
						...
						<img
							...
							alt="Screenshot af react.dev/learn"
						/>
						...
						<img
							...
							alt="Screenshot af Git, som er hvordan man arbejde med versionsstyring"
						/>
						...
						<img
							...
							alt="Screenshot af et kodestykke for at vise brugen af BEM"
						/>
						<img
							className="ressources__images"
