		...
		<>
			<section className="page-container culture">
				<div className="culture__desktopblop">
					...
					/>
					<Blurryblop
						style={{ top: "850px", left: "30px", width: "600px" }}
					/>
					<Blurryblop
						style={{ top: "2000px", left: "600px", width: "900px" }}
					/>
					<Blurryblop
						style={{ top: "3500px", left: "30px", width: "900px" }}
					/>
				</div>
				<div className="culture__cultureblop">
					...
					/>
					<Blurryblop
						style={{ top: "1000px", left: "-40px"}}
					/>
					<Blurryblop
						style={{ top: "2080px", left: "80px"}}
					/>
					<Blurryblop
						style={{ top: "3700px", left: "80px" }}
					/>
				</div>
				<ContentHeader
