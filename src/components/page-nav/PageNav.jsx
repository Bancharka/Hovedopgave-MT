...
export default function PageNav() {
	...
	return (
		<nav aria-label="Paginering" className="page-nav page-container">
			{prevPage && (
				<Link to={prevPage.path} aria-label="Forrige side" className="page-nav__prev">
					<img
			...
			{nextPage && nextPage.label && (
				<Link to={nextPage.path} aria-label="Næste side" className="page-nav__next">
					{nextPage.label}
					<img
